...
static mmux_asciizcp_t		src_pathname_asciiz = "./test-file-system-readlink-malloc.src.ext";
static mmux_asciizcp_t		lnk_pathname_asciiz = "./test-file-system-readlink-malloc.lnk.ext";
...
main (int argc MMUX_CC_LIBC_UNUSED, char const *const argv[] MMUX_CC_LIBC_UNUSED)
{
  ...
  {
    mmux_cc_libc_init();
    PROGNAME = "test-file-system-readlink-malloc";
  ...
  /* Do it. */
  {
    ...
    printf_message("readlink_mallocing");
    if (mmux_libc_readlink_malloc(&rea_ptn, lnk_ptn)) {
      handle_error();
    }
