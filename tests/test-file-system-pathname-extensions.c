...
making_an_extension_from_raw_arguments (void)
{
  ...
  if (mmux_libc_file_system_pathname_asciizp_ref(&ptn_asciiz, ptn)) {
    handle_error();
  }
...
static void
one_predicate (bool expected_equal,
		...
		mmux_asciizcp_t ptn_asciiz_1, mmux_asciizcp_t ptn_asciiz_2)
{
  ...
  if (mmux_libc_make_file_system_pathname(&ptn1, ptn_asciiz_1)) {
    ...
    if (mmux_libc_file_system_pathname_extension_equal(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid equal predicate, expected_equal %d, result %d", ext1.ptr, ext2.ptr, expected_equal, result);
      mmux_libc_exit_failure();
    }
    ...
    if (mmux_libc_file_system_pathname_extension_not_equal(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid not_equal predicate, expected_not_equal %d, result %d", ext1.ptr, ext2.ptr, !expected_equal, result);
      mmux_libc_exit_failure();
    }
    ...
    if (mmux_libc_file_system_pathname_extension_less(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid less predicate, expected_less %d, result %d", ext1.ptr, ext2.ptr, expected_less, result);
      mmux_libc_exit_failure();
    }
    ...
    if (mmux_libc_file_system_pathname_extension_greater(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid greater predicate, expected_greater %d, result %d", ext1.ptr, ext2.ptr, expected_greater, result);
      mmux_libc_exit_failure();
    }
    ...
    if (mmux_libc_file_system_pathname_extension_less_equal(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid less_equal predicate, expected_less_equal %d, result %d", ext1.ptr, ext2.ptr, expected_less_equal, result);
      mmux_libc_exit_failure();
    }
    ...
    if (mmux_libc_file_system_pathname_extension_greater_equal(&result, ext1, ext2)) {
      ...
      printf_error("ext1=%s, ext2=%s, invalid greater_equal predicate, expected_greater_equal %d, result %d", ext1.ptr, ext2.ptr, expected_greater_equal, result);
      mmux_libc_exit_failure();
    }
  }
}
static void
predicate_functions (void)
{
  printf_message("running test: %s", __func__);

  //            =      <      >       <=     >=
  one_predicate(true,  false, false,  true,  true,	"/path/to/file.ext",		"/path/to/file.ext");
  one_predicate(false, true,  false,  true,  false,	"/path/to/file.AAA",		"/path/to/file.BBB");
  one_predicate(false, false, true,   false, true,	"/path/to/file.BBB",		"/path/to/file.AAA");
}
