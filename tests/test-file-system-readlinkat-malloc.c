...
static mmux_asciizcp_t		src_pathname_asciiz = "./test-file-system-readlinkat-malloc.src.ext";
static mmux_asciizcp_t		lnk_pathname_asciiz = "./test-file-system-readlinkat-malloc.lnk.ext";
...
main (int argc MMUX_CC_LIBC_UNUSED, char const *const argv[] MMUX_CC_LIBC_UNUSED)
{
  ...
  {
    mmux_cc_libc_init();
    PROGNAME = "test-file-system-readlinkat-malloc";
  ...
  /* Do it. */
  {
    ...
    printf_message("readlinkat_mallocing");
    if (mmux_libc_readlinkat_malloc(&rea_ptn, dirfd, lnk_ptn)) {
      handle_error();
    }
