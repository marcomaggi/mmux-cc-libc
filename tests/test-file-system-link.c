...
static mmux_asciizcp_t		src_pathname_asciiz = "./test-file-system-link.src.ext";
static mmux_asciizcp_t		dst_pathname_asciiz = "./test-file-system-link.dst.ext";
...
main (int argc MMUX_CC_LIBC_UNUSED, char const *const argv[] MMUX_CC_LIBC_UNUSED)
{
  ...
  /* Do it. */
  {
    ...
    if (mmux_libc_link(src_ptn, dst_ptn)) {
      handle_error();
    }
