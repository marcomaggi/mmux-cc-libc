...
bool
mmux_libc_string_class__final (mmux_libc_str_t str)
{
...
static mmux_libc_string_class_t const	mmux_libc_string_class_static = {
  ...
  .final		= mmux_libc_string_class__final,
};
...
bool
mmux_libc_string_ref (mmux_char_t * char_result_p, mmux_libc_str_arg_t str, mmux_index_t idx)
{
  mmux_index_t	len;
