...

/** --------------------------------------------------------------------
 ** Networking sockets: exact integer wrappers.
 ** ----------------------------------------------------------------- */

mmux_cc_libc_inline_decl mmux_libc_network_address_family_t
mmux_libc_network_address_family (mmux_standard_sshort_t value)
{
  return (mmux_libc_network_address_family_t) { .value = value };
}
mmux_cc_libc_inline_decl mmux_libc_network_protocol_family_t
mmux_libc_network_protocol_family (mmux_standard_sint_t value)
{
...
mmux_cc_libc_inline_decl mmux_libc_network_socket_communication_style_t
mmux_libc_network_socket_communication_style (mmux_standard_sint_t value)
{
...
{
  return (mmux_libc_network_addrinfo_flags_t) { .value = value };
}
...
mmux_cc_libc_decl bool mmux_libc_network_socket_communication_style_equal
...
mmux_cc_libc_inline_decl mmux_libc_network_byteorder_uint32_t
mmux_libc_network_byteorder_uint32 (mmux_standard_uint32_t value)
{
  return (mmux_libc_network_byteorder_uint32_t) { .value = value };
}
mmux_cc_libc_inline_decl mmux_libc_host_byteorder_uint32_t
mmux_libc_host_byteorder_uint32 (mmux_standard_uint32_t value)
{
  return (mmux_libc_host_byteorder_uint32_t) { .value = value };
}

#define mmux_libc_network_byteorder_uint32_literal(LITERAL_VALUE)	\
  (mmux_libc_network_byteorder_uint32(mmux_standard_uint32_literal(LITERAL_VALUE)))

#define mmux_libc_host_byteorder_uint32_literal(LITERAL_VALUE)	\
  (mmux_libc_host_byteorder_uint32(mmux_standard_uint32_literal(LITERAL_VALUE)))

/* ------------------------------------------------------------------ */

mmux_cc_libc_inline_decl mmux_libc_host_byteorder_uint16_t
mmux_libc_host_byteorder_uint16 (mmux_standard_uint16_t value)
{
  return (mmux_libc_host_byteorder_uint16_t) { .value = value };
}
mmux_cc_libc_inline_decl mmux_libc_network_byteorder_uint16_t
mmux_libc_network_byteorder_uint16 (mmux_standard_uint16_t value)
{
  return (mmux_libc_network_byteorder_uint16_t) { .value = value };
}

#define mmux_libc_network_byteorder_uint16_literal(LITERAL_VALUE)	\
  (mmux_libc_network_byteorder_uint16(mmux_standard_uint16_literal(LITERAL_VALUE)))

#define mmux_libc_host_byteorder_uint16_literal(LITERAL_VALUE)	\
  (mmux_libc_host_byteorder_uint16(mmux_standard_uint16_literal(LITERAL_VALUE)))

/* ------------------------------------------------------------------ */

mmux_cc_libc_inline_decl mmux_libc_network_port_number_t
mmux_libc_network_port_number (mmux_libc_network_byteorder_uint16_t network_byteroder_value)
{
  return (mmux_libc_network_port_number_t) { .value = network_byteroder_value.value };
}

#define mmux_libc_network_port_number_literal(NETWORK_BYTEORDER_LITERAL)	\
  (mmux_libc_network_port_number(mmux_libc_network_byteorder_uint16_literal(NETWORK_BYTEORDER_LITERAL)))

mmux_cc_libc_decl mmux_libc_network_port_number_t \
mmux_libc_network_port_number_from_host_byteorder_value (mmux_libc_host_byteorder_uint16_t value);

#define mmux_libc_network_port_number_from_host_byteorder_literal(HOST_BYTEORDER_LITERAL) \
  (mmux_libc_network_port_number_from_host_byteorder_value(mmux_libc_host_byteorder_uint16_literal(HOST_BYTEORDER_LITERAL)))

#define mmux_libc_network_port_number_from_network_byteorder_literal(NETWORK_BYTEORDER_LITERAL) \
  (mmux_libc_network_port_number_literal(NETWORK_BYTEORDER_LITERAL))


/** --------------------------------------------------------------------
 ** Networking sockets: networking interface name-index association.
 ** ----------------------------------------------------------------- */
...

/** --------------------------------------------------------------------
 ** Networking sockets: internet protocol addresses.
 ** ----------------------------------------------------------------- */

bool mmux_libc_s_addr_set (mmux_libc_ipfour_addr_t ipfour_addr, mmux_libc_network_byteorder_uint32_t raw_address_number)
  __attribute__((__nonnull__(1)));

bool mmux_libc_s_addr_ref (mmux_libc_network_byteorder_uint32_t * raw_address_number_result_p,
			   mmux_libc_ipfour_addr_arg_t ipfour_addr)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr (mmux_libc_ipfour_addr_t in_addr_p,
						   mmux_libc_network_byteorder_uint32_t raw_internet_address)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr_none (mmux_libc_ipfour_addr_t in_addr_p)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr_any (mmux_libc_ipfour_addr_t in_addr_p)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr_broadcast (mmux_libc_ipfour_addr_t in_addr_p)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr_loopback (mmux_libc_ipfour_addr_t in_addr_p)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipfour_addr_from_asciiz (mmux_libc_ipfour_addr_t ipfour_addr_result,
							       mmux_asciizcp_t dotted_quad)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_ipfour_addr_reset (mmux_libc_ipfour_addr_t address)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_ipfour_addr_dump (mmux_libc_fd_arg_t fd, mmux_libc_ipfour_addr_arg_t ipfour_addr,
						   mmux_asciizcp_t struct_name)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_ipfour_addr_equal (bool * result_p,
...
mmux_cc_libc_decl bool mmux_libc_make_ipsix_addr_loopback (mmux_libc_ipsix_addr_t ipsix_addr_result)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipsix_addr_any (mmux_libc_ipsix_addr_t ipsix_addr_result)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_make_ipsix_addr_from_asciiz (mmux_libc_ipsix_addr_t ipsix_addr_result,
							      mmux_asciizcp_t dotted_quad)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_ipsix_addr_reset (mmux_libc_ipsix_addr_t address)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_ipsix_addr_dump (mmux_libc_fd_arg_t fd, mmux_libc_ipsix_addr_arg_t ipsix_addr,
						  mmux_asciizcp_t struct_name)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_ipsix_addr_equal (bool * result_p,
...

/** --------------------------------------------------------------------
 ** Networking sockets: databases.
 ** ----------------------------------------------------------------- */

mmux_cc_libc_decl bool mmux_libc_h_name_set (mmux_libc_hostent_t P, mmux_asciizp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_name_ref (mmux_asciizpp_t result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_aliases_set (mmux_libc_hostent_t P, mmux_asciizpp_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_h_aliases_ref (mmux_asciizpp_t result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_addrtype_set (mmux_libc_hostent_t P, mmux_libc_network_address_family_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_h_addrtype_ref (mmux_libc_network_address_family_t * result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_length_set (mmux_libc_hostent_t P, mmux_usize_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_h_length_ref (mmux_usize_t * result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_addr_list_set (mmux_libc_hostent_t P, mmux_asciizpp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_addr_list_ref (mmux_asciizpp_t * result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_addr_set (mmux_libc_hostent_t P, mmux_asciizp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_h_addr_ref (mmux_asciizp_t * result_p, mmux_libc_hostent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_hostent_dump (mmux_libc_fd_arg_t fd, mmux_libc_hostent_arg_t hostent_p,
					       mmux_asciizcp_t struct_name)
  __attribute__((__nonnull__(1,2)));
...
mmux_cc_libc_decl bool mmux_libc_gethostent (bool * there_is_one_more_p, mmux_libc_hostent_t hostent_result)
  __attribute__((__nonnull__(1)));

/* ------------------------------------------------------------------ */

mmux_cc_libc_decl bool mmux_libc_s_name_set (mmux_libc_servent_t P, mmux_asciizp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_name_ref (mmux_asciizpp_t result_p, mmux_libc_servent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_aliases_set (mmux_libc_servent_t P, mmux_asciizpp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_aliases_ref (mmux_asciizpp_t result_p, mmux_libc_servent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_port_set (mmux_libc_servent_t P, mmux_libc_network_port_number_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_s_port_ref (mmux_libc_network_port_number_t * result_p, mmux_libc_servent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_proto_set (mmux_libc_servent_t P, mmux_asciizp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_s_proto_ref (mmux_asciizpp_t result_p, mmux_libc_servent_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_servent_dump (mmux_libc_fd_arg_t fd, mmux_libc_servent_arg_t servent_p,
...
mmux_cc_libc_decl bool mmux_libc_getservent (bool * there_is_one_more_p, mmux_libc_servent_t servent_result)
  __attribute__((__nonnull__(1,2)));

/* The argument "protocol_name_p" can be NULL, see the manpage. */
mmux_cc_libc_decl bool mmux_libc_getservbyname (bool * there_is_one_p, mmux_libc_servent_t servent_result,
						mmux_asciizcp_t service_name_p, mmux_asciizcp_t protocol_name_p)
  __attribute__((__nonnull__(1,2,3),__warn_unused_result__));

/* The argument "protocol_name_p" can be NULL, see the manpage. */
mmux_cc_libc_decl bool mmux_libc_getservbyport (bool * there_is_one_p, mmux_libc_servent_t servent_result,
...
mmux_cc_libc_decl bool mmux_libc_sockaddr_bind_length (mmux_libc_socklen_t * sockaddr_length_result_p,
...
mmux_cc_libc_decl bool mmux_libc_sockaddr_local_bind_length (mmux_libc_socklen_t * sockaddr_local_length_result_p,
							     mmux_libc_sockaddr_local_arg_t P)
  __attribute__((__nonnull__(1,2)));
...
mmux_cc_libc_decl bool mmux_libc_sockaddr_ipfour_bind_length (mmux_libc_socklen_t * sockaddr_ipfour_length_result_p,
							      mmux_libc_sockaddr_ipfour_arg_t P)
  __attribute__((__nonnull__(1,2)));
...
mmux_cc_libc_decl bool mmux_libc_sockaddr_ipsix_bind_length (mmux_libc_socklen_t * sockaddr_ipsix_length_result_p,
							     mmux_libc_sockaddr_ipsix_arg_t P)
  __attribute__((__nonnull__(1,2)));
...
mmux_cc_libc_decl bool mmux_libc_addrinfo_family_set (mmux_libc_addrinfo_t P,
						      mmux_libc_network_address_family_t new_field_value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_family_ref (mmux_libc_network_address_family_t * field_value_result_p,
						      mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_socket_communication_style_set
    (mmux_libc_addrinfo_t P, mmux_libc_network_socket_communication_style_t new_field_value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_socket_communication_style_ref
    (mmux_libc_network_socket_communication_style_t * field_value_result_p, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_internet_protocol_set
    (mmux_libc_addrinfo_t P, mmux_libc_network_internet_protocol_t new_field_value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_internet_protocol_ref
    (mmux_libc_network_internet_protocol_t * field_value_result_p, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_flags_set
    (mmux_libc_addrinfo_t P, mmux_libc_network_addrinfo_flags_t new_field_value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_flags_ref
    (mmux_libc_network_addrinfo_flags_t * field_value_result_p, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_addrlen_set (mmux_libc_addrinfo_t P, mmux_libc_socklen_t new_field_value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_addrlen_ref
    (mmux_libc_socklen_t * field_value_result_p, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_sockaddr_set (mmux_libc_addrinfo_t P, mmux_libc_sockaddr_arg_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_sockaddr_ref (mmux_libc_sockaddr_t sockaddr_result, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_canonname_set (mmux_libc_addrinfo_t P, mmux_asciizcp_t value)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_canonname_ref (mmux_asciizcp_t * result_p, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_next_set (mmux_libc_addrinfo_t P, mmux_libc_addrinfo_arg_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_addrinfo_next_ref
    (bool * there_is_one_more_result_p, mmux_libc_addrinfo_t addrinfo_result, mmux_libc_addrinfo_arg_t P)
  __attribute__((__nonnull__(1,2,3)));
...
mmux_cc_libc_decl bool mmux_libc_ntohs (mmux_libc_host_byteorder_uint16_t * result_p, mmux_libc_network_byteorder_uint16_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_htonl (mmux_libc_network_byteorder_uint32_t * result_p, mmux_libc_host_byteorder_uint32_t value)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_ntohl (mmux_libc_host_byteorder_uint32_t * result_p, mmux_libc_network_byteorder_uint32_t value)
  __attribute__((__nonnull__(1)));

__attribute__((__nonnull__(1,2))) mmux_cc_libc_inline_decl bool
mmux_libc_htons_p (mmux_libc_network_byteorder_uint16_t * result_p, mmux_libc_host_byteorder_uint16_t * value_p)
{
  return mmux_libc_htons(result_p, *value_p);
}
__attribute__((__nonnull__(1,2))) mmux_cc_libc_inline_decl bool
mmux_libc_ntohs_p (mmux_libc_host_byteorder_uint16_t * result_p, mmux_libc_network_byteorder_uint16_t * value_p)
{
  return mmux_libc_ntohs(result_p, *value_p);
}
__attribute__((__nonnull__(1,2))) mmux_cc_libc_inline_decl bool
mmux_libc_htonl_p (mmux_libc_network_byteorder_uint32_t * result_p, mmux_libc_host_byteorder_uint32_t * value_p)
{
  return mmux_libc_htonl(result_p, *value_p);
}
__attribute__((__nonnull__(1,2))) mmux_cc_libc_inline_decl bool
mmux_libc_ntohl_p (mmux_libc_host_byteorder_uint32_t * result_p, mmux_libc_network_byteorder_uint32_t * value_p)
{
...
mmux_cc_libc_decl bool mmux_libc_inet_ntoa (mmux_asciizp_t ouput_presentation_p,
					    mmux_usize_t ouput_presentation_provided_nchars,
					    mmux_libc_ipfour_addr_arg_t input_addr_p)
  __attribute__((__nonnull__(1,3)));

mmux_cc_libc_decl bool mmux_libc_inet_pton (mmux_libc_ip_addr_t ouput_addr_p,
					    mmux_libc_network_address_family_t input_af_family,
					    mmux_asciizcp_t input_presentation_p)
  __attribute__((__nonnull__(1,3)));

mmux_cc_libc_decl bool mmux_libc_inet_ntop (mmux_asciizp_t ouput_presentation_p,
					    mmux_usize_t ouput_presentation_provided_nchars,
					    mmux_libc_network_address_family_t input_af_family,
					    mmux_libc_ip_addr_arg_t input_addr)
  __attribute__((__nonnull__(1,4)));

mmux_cc_libc_decl bool mmux_libc_inet_net_pton (mmux_libc_ip_addr_t address_result,
						mmux_uint_t * number_of_bits_result,
						mmux_libc_network_address_family_t family,
						mmux_asciizcp_t presentation)
  __attribute__((__nonnull__(1,4)));

mmux_cc_libc_decl bool mmux_libc_inet_net_ntop (mmux_asciizp_t presentation_result,
						mmux_usize_t presentation_provided_nbytes,
						mmux_libc_network_address_family_t family,
						mmux_libc_ip_addr_arg_t address,
						mmux_uint_t number_of_bits)
  __attribute__((__nonnull__(1,4)));

mmux_cc_libc_decl bool mmux_libc_inet_addr (mmux_libc_ipfour_addr_t result_ip_addr_p,
					    mmux_asciizcp_t presentation_ip_addr_p)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_inet_network (mmux_libc_ipfour_addr_t result_ip_addr_p,
					       mmux_asciizcp_t presentation_ip_addr_p)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_inet_makeaddr (mmux_libc_ipfour_addr_t ipfour_addr_result,
						mmux_libc_host_byteorder_uint32_t network_address_number,
						mmux_libc_host_byteorder_uint32_t local_address_number)
  __attribute__((__nonnull__(1)));

mmux_cc_libc_decl bool mmux_libc_inet_lnaof (mmux_libc_host_byteorder_uint32_t * local_address_number_result_p,
					     mmux_libc_ipfour_addr_arg_t ipfour_addr)
  __attribute__((__nonnull__(1,2)));

mmux_cc_libc_decl bool mmux_libc_inet_netof (mmux_libc_host_byteorder_uint32_t * network_address_number_result_p,
					     mmux_libc_ipfour_addr_arg_t ipfour_addr)
  __attribute__((__nonnull__(1,2)));
